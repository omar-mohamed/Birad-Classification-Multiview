...
class AugmentedImageSequence(Sequence):
    ...
    def __getitem__(self, idx):
        ...
        batch_x_dm_path = self.x_path_dm[idx * self.batch_size:(idx + 1) * self.batch_size]
        ...
        batch2 = zip(batch_x_dm_path, batch_sides)
        batch_x2 = np.asarray([self.load_image(x_path, side) for x_path, side in batch2])

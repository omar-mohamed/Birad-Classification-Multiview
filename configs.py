class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('visual_model_name', 'EfficientNetB7',
        ...
        self.define('classifier_layer_sizes', [0.6],
        ...
        self.define('learning_rate_decay_factor', 0.8,
        ...
        self.define('generator_workers', 6, 'The number of cpu workers generating batches.')
        self.define('generator_queue_length', 30, 'The maximum number of batches in the queue to be trained on.')
        self.define('minimum_learning_rate', 1e-7, 'The minimum possible learning rate when decaying')
        self.define('reduce_lr_patience', 10,
